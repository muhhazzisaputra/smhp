        ...
        <div class="table-responsive">
            <table class="table table-sm table-borderless text-nowrap">
                <tr>
                    ...
                    <td><input class="form-control" type="text" name="id_mesin" id="id_mesin" value="<?php echo $mesin->IdMesin ?>" style="width: 65px; cursor: not-allowed;" readonly required></td>
                </tr>
                <tr>
                    <td>No Mesin<span style="color: red;">*</span></td>
                    <td>:</td>
                    <td><input class="form-control numeric-only" type="text" name="no_mesin" id="no_mesin" value="<?php echo $mesin->NoMesin ?>" style="width: 62px;" maxlength="3" required></td>
                </tr>
            </table>
        </div>
...
<script type="text/javascript">
    function update_data() {
        ...
        $.post('<?php echo base_url() ?>mesin/update_data', {id_mesin, no_mesin}, function(result) {
