<div class="modal-body">
    <h4>Detail Hasil Produksi Per Tanggal</h4>
    <form method="post" action="<?php echo base_url() ?>laporan_hasil_produksi/detail_hasil_pertgl/xls" target="_blank">
        ...
        <table class="table table-sm table-borderless text-nowrap">
            <tr>
                ...
                <td><?php echo date('d-M-Y', strtotime($row->TglProduksi)) ?></td>
            </tr>
            <tr>
                <td>Produk</td>
                <td>:</td>
