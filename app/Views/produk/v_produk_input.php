        ...
        <div class="table-responsive">
            <table class="table table-sm table-borderless text-nowrap">
                <tr>
                    ...
                    <td><input type="text" name="id_produk" id="id_produk" value="<?php echo $maxCode ?>" class="form-control" style="width: 70px; cursor: not-allowed;" readonly required></td>
                </tr>
                <tr>
                    <td>Nama Produk<span style="color: red;">*</span></td>
                    <td>:</td>
                    <td><input type="text" name="nama_produk" id="nama_produk" class="form-control" style="width: 325px;" required></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="1" name="aktif" value="1" style="margin-top: 6px;" checked>
                                <label for="1" class="form-check-label">Ya</label>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <input class="form-check-input" type="radio" id="2" name="aktif" value="2" style="margin-top: 6px;">
                ...
                <tr>
                    <td></td>
                    <td></td>
                    <td><img src="<?php echo base_url() ?>uploads/no-product-image.png" id="preview_img_set" alt="Gambar Produk" class="img-thumbnail" style="height: 115px; width: 120px;" onclick="preview_img(this)"></td>
                </tr>
            </table>
        </div>
